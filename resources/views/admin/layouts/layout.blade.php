        ...
        <div class="wrapper">
                ...
                <header class="main-header">
                  ...
                  <a href="{{url('/adminpanel')}}" class="logo">
                    ...
                    <span class="logo-lg"><b>Keto</b>LTE</span>
                  </a>
                    ...
                    <!-- sidebar menu: : style can be found in sidebar.less -->
                      ...
                      <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="active treeview">
                          ...
                          <li class="active treeview">
                            <a href="#">
                              <i class="glyphicon glyphicon-cutlery"></i> <span>Meals Control</span>
                              <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                              </span>
                            </a>
                            <ul class="treeview-menu">
                              <li class="active"><a href="/adminpanel/meals/create"><i class="glyphicon glyphicon-cutlery"></i>Add New Meal</a></li>
                              <li><a href="/adminpanel/meals"><i class="glyphicon glyphicon-cutlery"></i> All Meals</a></li>
                            </ul>
                          </li>
